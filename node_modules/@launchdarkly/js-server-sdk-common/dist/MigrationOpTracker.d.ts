...
export default class MigrationOpTracker implements LDMigrationTracker {
    ...
    private _operation?;
    constructor(_flagKey: string, _contextKeys: Record<string, string>, _defaultStage: LDMigrationStage, _stage: LDMigrationStage, _reason: LDEvaluationReason, _checkRatio?: number | undefined, _variation?: number | undefined, _version?: number | undefined, _samplingRatio?: number | undefined, _logger?: LDLogger | undefined);
